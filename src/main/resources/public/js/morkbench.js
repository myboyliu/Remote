        ...
        success: function (data) {
            ...
            if (data.status == 200) {
                ...
                for (var i = 0; i < tempArr.length; i++) {
                    ...
                    if (tempArr[i].readFlag == 0) {
                        // 未读
                        _html += '<tr class="unread" applyFlag="' + tempArr[i].readFlag + '" type="2" name="' + tempArr[i].id + '">\
                            <td>';
                    } else {
                        // 已读
                        _html += '<tr class="read" applyFlag="' + tempArr[i].readFlag + '" type="2" name="' + tempArr[i].id + '">\
                            <td>';
                    }
        ...
        success: function (data) {
            ...
            if (data.status == 200) {
                ...
                for (var i = 0; i < tempArr.length; i++) {
                    ...
                    var _day = timeStr.split('-')[2];
                    if (tempArr[i].applyFlag == 0) {
                        _html += '<tr class="unread" applyFlag="' + tempArr[i].applyFlag + '" type="3" name="' + tempArr[i].id + '">\
                            <td>'
                    } else {
                        _html += '<tr class="read" applyFlag="' + tempArr[i].applyFlag + '" type="3" name="' + tempArr[i].id + '">\
                            <td>'
                    }
                    if (tempArr[i].isurgent == 1) {
                        _html += '<img class="w14" src="/yilaiyiwang/images/light.png" />'
                    ...
                    _html += '<td>\
                        ...
                        <td>\
							<p class="overHidden1" style=" width:270px;" title="' + tempArr[i].inName + ';' + tempArr[i].inTitle + ';' + tempArr[i].inDeptName + ';' + tempArr[i].inHospitalName + '">\
								<' + tempArr[i].inName + ';' + tempArr[i].inTitle + ';' + tempArr[i].inDeptName + ';' + tempArr[i].inHospitalName + '>\
							</p>\
						</td>\
						<td>\
							<p class="overHidden2"style=" width:160px;" title="' + tempArr[i].outName + ';' + tempArr[i].outTitle + ';' + tempArr[i].outDeptName + ';' + tempArr[i].outHospitalName + '">\
								<' + tempArr[i].outName + ';' + tempArr[i].outTitle + ';' + tempArr[i].outDeptName + ';' + tempArr[i].outHospitalName + '>\
							</p>\
						</td>'
                    if (tempArr[i].manner == 0) {

        ...
        layui.use('laypage', function () {
            ...
            laypage.render({
                ...
                jump: function (obj, first) {
                    ...
                    if( $(".classifyObj > a.active").attr("name") !== "LIVE_ALL"){
                        listData.push({
                            liveType: $(".classifyObj > a.active").attr("name")
                        })
                    }
    ...
    for (let i = 0; i < liveList.length; i++) {
        _html += '<div name="' + liveList[i].id + '" class="itemBox">\
                                ...
                                <div class="rightBox">\
                                    ...
                                    <p class="videoInfo">' + liveList[i].liveBranch + '-' + liveList[i].liveBranch + '</p>\
                                    <p class="lievTime">' + liveList[i].liveStartTime + '</p>\
                                </div>'
        if (liveList[i].isFollow) {
        ...
        _html += '<p class="videoDesc">简介：' + liveList[i].liveDescription + '</p>\
                                <div class="popularBox">\
                                    ...
                                    <span>关注</span>\
                                    <i class="playNum">' + liveList[i].followNum + '</i>\
                                </div>\
                            </div>';
    }
